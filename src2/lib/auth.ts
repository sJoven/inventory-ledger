...
//JWT: userid string, is_client array, is_admin array
...
//example is_admin array array: [{store_id: "id-123", role: "super"}, {store_id: "id-456", role: "clerk"}, ...]
//example is_client array array: ["store_id-123", "store_id-456", ...]
